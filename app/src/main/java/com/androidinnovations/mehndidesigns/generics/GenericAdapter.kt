...
import com.androidinnovations.mehndidesigns.BR
...
class GenericAdapter<T : ListItemViewModel>(@LayoutRes val layoutId: Int) :
    ...
    var swipeToDeleteCallback:  com.androidinnovations.mehndidesigns.util.SwipeToDeleteCallback? = null
    ...
    fun enableSwipeToDeleteAndUndo(
        ...
        if (swipeToDeleteCallback == null) {
            ...
            swipeToDeleteCallback = object :
                com.androidinnovations.mehndidesigns.util.SwipeToDeleteCallback(recyclerView!!.context, false) {
